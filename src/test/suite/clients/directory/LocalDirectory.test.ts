...
import { LocalDirectory } from '../../../../clients/directory/LocalDirectory';

suite('LocalDirectory Test Suite', () => {
    test('search should return empty result for invalid search term', async () => {
